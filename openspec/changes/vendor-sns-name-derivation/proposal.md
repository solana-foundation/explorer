...
- **Wait for a kit-native Bonfida release** — rejected for now: none exists, and the migration plan already lists hand-rolling as the fallback for this dependency (plan task 5.3). This pulls that decision forward because task 0.2 forced the issue.
