                ...
                return (
                    ...
                    >
                        ...
                        <BaseTable.Row>
                            ...
                            <BaseTable.Cell className="font-monospace e-text-right">{`${new Intl.NumberFormat(
                                'en-US',
                ...
                return (
                    ...
                    >
                        ...
                        <BaseTable.Row>
                            ...
                            <BaseTable.Cell className="font-monospace e-text-right">{`${microLamportsToLamportsString(
                                microLamports,
                ...
                return (
                    ...
                    >
                        ...
                        <BaseTable.Row>
                            ...
                            <BaseTable.Cell className="font-monospace e-text-right">{`${accountDataSizeLimit} bytes`}</BaseTable.Cell>
                        </BaseTable.Row>
                    </InstructionCardComponent>
                );
            }
