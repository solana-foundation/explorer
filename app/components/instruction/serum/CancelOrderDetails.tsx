    ...
    return (
        ...
        >
            ...
            <BaseTable.Row>
                ...
                <BaseTable.Cell className="e-text-right">{info.data.openOrdersSlot}</BaseTable.Cell>
            </BaseTable.Row>

            <BaseTable.Row>
                <BaseTable.Cell>Order Id</BaseTable.Cell>
                <BaseTable.Cell className="e-text-right">{info.data.orderId.toString(10)}</BaseTable.Cell>
            </BaseTable.Row>
        </InstructionCard>
    );
}
