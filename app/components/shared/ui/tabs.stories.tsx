        ...
        <Tabs defaultValue="account">
            ...
            <TabsContent value="password">
                <div className="mt-4 space-y-2">
                    ...
                    <p className="text-sm text-neutral-400">Change your password here.</p>
                </div>
            </TabsContent>
            <TabsContent value="settings">
                <div className="mt-4 space-y-2">
                    <h3 className="text-lg font-semibold">Settings</h3>
                    <p className="text-sm text-neutral-400">Manage your settings and preferences.</p>
                </div>
            </TabsContent>
        </Tabs>
    ),
            ...
            <Tabs defaultValue={tabs[0].value}>
                ...
                {tabs.map(tab => (
                    <TabsContent key={tab.value} value={tab.value}>
                        <div className="mt-4">
                            <p className="text-sm text-neutral-400">{tab.content}</p>
                        </div>
                    </TabsContent>
                ))}
            </Tabs>
        ...
        <Tabs defaultValue="overview">
            ...
            <TabsContent value="details">
                <div className="mt-4">
                    ...
                    <p className="mt-2 text-sm text-neutral-400">Detailed information goes here.</p>
                </div>
            </TabsContent>
            <TabsContent value="history">
                <div className="mt-4">
                    <h3 className="text-lg font-semibold">History</h3>
                    <p className="mt-2 text-sm text-neutral-400">Historical data and records.</p>
                </div>
            </TabsContent>
        </Tabs>
    ),
        ...
        const ControlledTabs = () => {
            ...
            return (
                <div className="space-y-4">
                    <div className="text-sm text-neutral-400">Current tab: {value}</div>
                    <Tabs value={value} onValueChange={setValue}>
                        ...
                        <TabsContent value="tab1">
                            <div className="mt-4">
                                <p className="text-sm text-neutral-400">Content for tab 1</p>
                            </div>
                        </TabsContent>
                        <TabsContent value="tab2">
                            <div className="mt-4">
                                <p className="text-sm text-neutral-400">Content for tab 2</p>
                            </div>
                        </TabsContent>
                        <TabsContent value="tab3">
                            <div className="mt-4">
                                <p className="text-sm text-neutral-400">Content for tab 3</p>
                            </div>
                        </TabsContent>
                    </Tabs>
                </div>
    ...
    render: () => (
        <Tabs defaultValue="active">
            ...
            <TabsContent value="active">
                <div className="mt-4">
                    <p className="text-sm text-neutral-400">This tab is active and clickable.</p>
                </div>
            </TabsContent>
            ...
            <TabsContent value="another">
                <div className="mt-4">
                    <p className="text-sm text-neutral-400">Another active tab.</p>
                </div>
            </TabsContent>
        </Tabs>
    ),
