...
[formatSerdeIdl]() - formats IDL into a format that could be used to construct AnchorProgram instance. Descendant of [convertLegacyIdl](https://github.com/solana-developers/helpers/blob/main/src/lib/convertLegacyIdl.ts), but reworked for Exporer's usage
