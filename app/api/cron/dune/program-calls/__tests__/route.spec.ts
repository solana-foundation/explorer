...
// NOTE: check that this thing works
...
vi.mock('@/app/entities/program-metadata/lib/getProgramNameFromIdl.ts', () => ({
    getProgramNameFromIdl: vi.fn().mockReturnValue(undefined),
}));
