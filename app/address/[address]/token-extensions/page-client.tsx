...
function TokenExtensionsEntriesRenderer({
    ...
    if (parsedData && parsedData.parsed.type === 'mint') {
        ...
        return <TokenExtensionsCard decimals={Number(mintInfo.decimals)} address={address} extensions={mintInfo.extensions} />;
        ...
        return <TokenExtensionsCard decimals={Number(accountInfo.tokenAmount.decimals)} address={address} extensions={accountInfo.extensions} />;
    } else {
        // possible cases:
        // - absent parsed data
