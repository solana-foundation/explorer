...
export enum PROGRAM_NAMES {
    ...
    PYTH_DEVNET = 'Pyth Oracle Program', // eslint-disable-next-line @typescript-eslint/no-duplicate-enum-values
    PYTH_TESTNET = 'Pyth Oracle Program', // eslint-disable-next-line @typescript-eslint/no-duplicate-enum-values
    PYTH_MAINNET = 'Pyth Oracle Program', // eslint-disable-next-line @typescript-eslint/no-duplicate-enum-values
