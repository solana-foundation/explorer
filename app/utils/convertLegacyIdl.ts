...
/// Problem: formatIdl is used to produce Idl to create a Program instance, but needed to display Idl also
...
export const formatExtIdl: IdlFormatter = (idl, programAddress?) => {
