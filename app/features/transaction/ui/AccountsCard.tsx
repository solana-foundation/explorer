...
export function AccountsCard({ signature }: SignatureProps) {
    ...
    // Sizes feed the footer total only; each row reads its own size from the account it expands. A
    // failed fetch leaves the map empty, which drops the footer and leaves the table untouched.
