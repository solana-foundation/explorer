...
export function TokenVerificationButton({
    ...
    return (
        <button
            ...
            className={`e-flex e-w-[160px] e-flex-col e-justify-between e-rounded e-border e-border-solid e-bg-[#1C2120] e-px-3 e-py-2 md:e-h-[stretch] md:e-min-h-[69px] ${
                isOpen ? 'e-border-green-400' : 'e-border-black'
            } ${isLoading ? 'e-cursor-not-allowed' : 'e-cursor-pointer'}`}
        >
            <div className="e-flex e-w-full e-items-center e-gap-2">
