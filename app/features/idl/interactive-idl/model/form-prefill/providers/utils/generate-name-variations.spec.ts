...
describe('generateNameVariations', () => {
    it('generates variations for system program', () => {
    ...
    it('generates variations for token program', () => {
    ...
    it('generates variations for associated token program', () => {
        const result = generateNameVariations(
    ...
    it('generates variations for ata program', () => {
    ...
    it('generates variations without additional keys', () => {
    ...
    it('generates variations with default empty additional keys', () => {
