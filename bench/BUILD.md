...
| Dynamic | `/block/[slot]/accounts` | 4.54 kB | 919 kB |
| Dynamic | `/block/[slot]/programs` | 5.13 kB | 919 kB |
| Dynamic | `/block/[slot]/rewards` | 5.06 kB | 924 kB |
| Dynamic | `/epoch/[epoch]` | 6.92 kB | 258 kB |
| Static | `/feature-gates` | 3.43 kB | 924 kB |
| Static | `/opengraph-image.png` | 0 B | 0 B |
| Static | `/supply` | 6.57 kB | 925 kB |
| Dynamic | `/tx/[signature]` | 37.5 kB | 1.39 MB |
| Dynamic | `/tx/[signature]/inspect` | 610 B | 1.19 MB |
