...
| Dynamic | `/address/[address]` | 12.8 kB | 975 kB |
| Dynamic | `/address/[address]/anchor-account` | 7.46 kB | 1.01 MB |
| Dynamic | `/address/[address]/anchor-program` | 336 B | 892 kB |
| Dynamic | `/address/[address]/attestation` | 6.26 kB | 983 kB |
| Dynamic | `/address/[address]/attributes` | 2.96 kB | 937 kB |
| Dynamic | `/address/[address]/blockhashes` | 2.35 kB | 936 kB |
| Dynamic | `/address/[address]/compression` | 5.62 kB | 972 kB |
| Dynamic | `/address/[address]/concurrent-merkle-tree` | 4.06 kB | 971 kB |
...
| Dynamic | `/address/[address]/idl` | 135 kB | 1.2 MB |
| Dynamic | `/address/[address]/instructions` | 8.67 kB | 1.05 MB |
| Dynamic | `/address/[address]/metadata` | 7.55 kB | 952 kB |
| Dynamic | `/address/[address]/nftoken-collection-nfts` | 9.15 kB | 1.02 MB |
| Dynamic | `/address/[address]/program-multisig` | 4.81 kB | 1.01 MB |
| Dynamic | `/address/[address]/rewards` | 4.32 kB | 941 kB |
| Dynamic | `/address/[address]/security` | 9.89 kB | 1.02 MB |
| Dynamic | `/address/[address]/slot-hashes` | 4.21 kB | 941 kB |
| Dynamic | `/address/[address]/stake-history` | 4.33 kB | 941 kB |
| Dynamic | `/address/[address]/token-extensions` | 13.6 kB | 1.02 MB |
| Dynamic | `/address/[address]/tokens` | 28.7 kB | 1.13 MB |
| Dynamic | `/address/[address]/transfers` | 11.7 kB | 1.07 MB |
| Dynamic | `/address/[address]/verified-build` | 7.44 kB | 1.01 MB |
...
| Dynamic | `/block/[slot]` | 9.54 kB | 960 kB |
...
| Dynamic | `/tx/[signature]` | 58.5 kB | 1.46 MB |
