// Legacy idl converted to modern anchor format via anchor idl convert
// Source program: SMPLecH534NA9acpos4G6x7uf3LWbCAwZQE9e8ZekMu (frozen)

export const squadsV3Idl = {
    ...
    instructions: [
        ...
        },
        {
            ...
            discriminator: [230, 97, 183, 248, 43, 190, 154, 29],
            accounts: [
                {
                    name: 'multisig',
                    writable: true,
        ...
        },
        {
            ...
            discriminator: [114, 213, 59, 47, 214, 157, 150, 170],
            accounts: [
                {
                    name: 'multisig',
                    writable: true,
        ...
        },
        {
            ...
            discriminator: [146, 151, 213, 63, 121, 79, 9, 29],
            accounts: [
                {
                    name: 'multisig',
                    writable: true,
        ...
        },
        {
            ...
            discriminator: [56, 17, 0, 163, 135, 11, 135, 32],
            accounts: [
                {
                    name: 'multisig',
                },
        ...
        },
        {
            ...
            discriminator: [11, 70, 136, 166, 202, 55, 246, 74],
            accounts: [
                {
                    name: 'multisig',
                },
        ...
        },
        {
            ...
            discriminator: [47, 141, 218, 192, 80, 97, 209, 116],
            accounts: [
                {
                    name: 'multisig',
                },
        ...
        },
        {
            ...
            discriminator: [65, 191, 19, 127, 230, 26, 214, 142],
            accounts: [
                {
                    name: 'multisig',
                    writable: true,
    ...
    accounts: [
        {
            name: 'Ms',
            discriminator: [70, 118, 9, 108, 254, 215, 31, 120],
        },
        {
            name: 'MsTransaction',
            discriminator: [182, 151, 104, 216, 255, 1, 19, 157],
        },
        {
            name: 'MsInstruction',
            discriminator: [238, 185, 126, 149, 189, 89, 255, 92],
        },
    ],
    errors: [
        {
