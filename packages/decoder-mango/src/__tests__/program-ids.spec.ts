...
describe('program-ids', () => {
    it('should expose the three Mango v3 program addresses', () => {
        expect(MANGO_PROGRAM_IDS.mainnet).toBe('mv3ekLzLbnVPNxjSKvqBpU3ZeZXPQdEC3bp5MDEBG68');
        expect(MANGO_PROGRAM_IDS.devnet).toBe('4skJ85cdxQAFVKbcGgfun8iZPL7BadVYXG3kGEGkufqA');
        expect(MANGO_PROGRAM_IDS.testnet).toBe('BXhdkETgbHrr5QmVBT1xbz3JrMM28u5djbVtmTUfmFTH');
    });
