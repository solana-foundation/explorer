        ...
        },
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    isMut: false;
                    isSigner: false;
                    docs: ['Derivation is checked by the shim.'];
                },
                {
                    name: 'guardianSignatures';
                    isMut: false;
                    isSigner: false;
                    docs: ['Ownership ownership and discriminator is checked by the shim.'];
                },
                {
                    name: 'verifyVaaShim';
                    isMut: false;
    ...
    accounts: [
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    {
                        name: 'threshold';
                        docs: ['The number of transceivers that must attest to a transfer before it is', 'accepted.'];
                        type: 'u8';
                    },
                    {
